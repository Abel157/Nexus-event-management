    ...
    return (
      ...
      <div className='navbar'>
        ...
        <div className="nav-left">
          <button className="nav-button login-btn" onClick={()=> navigate('adminlogin')}>Log In</button>
          <button className="nav-button events-btn" onClick={()=> navigate('property')} >EVENTS</button>
        </div>
      </div>
